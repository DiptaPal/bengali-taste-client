...
const Signin = () => {
    const { setLoader, singInWithGoogle, logIn, passwordReset } = useContext(AuthContext);
            ...
            <div className="w-full max-w-lg p-8 space-y-3 rounded-xl shadow-lg text-black border-activeColor border bg-gray-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-2">
                        ...
                        <input onBlur={handlePasswordError} type="email" name="email" id="email" placeholder="Email" className="w-full px-4 py-3 text-xl border focus:border-navActive outline-none rounded-md border-gray-300 bg-gray-50 text-gray-800" required />
                    </div>
                    <div className="space-y-2">
                        ...
                        <div onClick={handleReset} className="flex justify-end text-base text-black">
                            <Link to="#/">Forgot Password?</Link>
                        </div>
                        <p className='text-red-500 font-medium text-base'>{error}</p>
                    </div>
                    <button type='submit' className="block w-full p-3 text-2xl font-semibold rounded-md text-center text-normalColor shadow bg-activeColor hover:text-black hover:bg-gray-300 transition-all duration-300 border-2 border-transparent hover:border-2">Sign in</button>
                </form>
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button aria-label="Log in with Twitter" className="p-3 rounded-sm cursor-not-allowed">
                    ...
                    <button  aria-label="Log in with GitHub" className="p-3 rounded-sm cursor-not-allowed">
